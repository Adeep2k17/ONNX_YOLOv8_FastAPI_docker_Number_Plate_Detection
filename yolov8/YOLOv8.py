...
class YOLOv8:
    ...
    def __init__(self, path:str, conf_thres:float = 0.5, iou_thres:float = 0.5) -> None:
    ...
    def prepare_input(self, image) -> Any:
    ...
    def inference(self, input_tensor) -> tuple[Any, Any, Any]:
    ...
    def process_output(self, output) -> tuple[np.ndarray, np.ndarray, np.ndarray]:
    ...
    def rescale_boxes(self, boxes) -> np.ndarray:
    ...
    def draw_detections(self, image: np.ndarray, draw_scores=True, mask_alpha=0.4) -> np.ndarray:
